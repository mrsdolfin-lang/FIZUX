...
function callWithModel(modelId, msgs, taskModel) {
  // Manual key takes priority over system keys (only if properly set)
  if(manualTextKey && manualTextKey.trim().length > 10){
...
function FIZUXApp(){
  ...
  var BG=isLight?'#F8F8FC':'rgba(5,5,15,0.0)';
  var CARD=isLight?'#FFFFFF':'rgba(16,16,30,0.85)';
  var CARD2=isLight?'#F0F0F8':'rgba(22,22,38,0.85)';
...
if(screen==='login'){
  ...
  return h('div',{
    ...
    // Header
    h('div',{className:'header-3d',style:{padding:'0 12px',height:'64px',display:'flex',alignItems:'center',gap:'8px',flexShrink:0,background:'rgba(0,0,8,0.7)',backdropFilter:'blur(20px)',WebkitBackdropFilter:'blur(20px)',borderBottom:'1px solid rgba(255,255,255,0.1)'}},
