...
var MODELS=[
  ...
  {id:'claude',   name:'Claude',      icon:'◆',color:'#C9A84C',free:false, key:'claudeKey'}
];
...
// openrouter/free = auto picks best free model - always works!
var OR_MODELS = {
  'deepseek':  'openrouter/free',
  'llama':     'openrouter/free',
  'gemini-or': 'openrouter/free',
...
function callAI(modelId, msgs, keys, userText) {
  ...
  if (eff === 'claude') {
    return Promise.reject(new Error('Claude model not available. Please select DeepSeek, Llama, or other free models.'));
  }
  ...
  var SettingsModal=showSettings ? h('div',{style:overlay()},
    h('div',{style:modalStyle({maxWidth:'440px'})},
      ...
      settingsTab==='ai' && h('div',null,
        h('div',{style:{fontSize:'11px',color:MUTED,marginBottom:'12px'}},'Optional: Add your own API keys for Gemini, OpenAI, or Grok.'),
