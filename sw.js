...
self.addEventListener('fetch',function(e){var url=e.request.url;if(url.indexOf('anthropic')>-1||url.indexOf('googleapis')>-1||url.indexOf('openai')>-1||url.indexOf('deepseek')>-1||url.indexOf('openrouter')>-1||url.indexOf('huggingface')>-1||url.indexOf('pollinations')>-1)return;e.respondWith(caches.match(e.request).then(function(r){return r||fetch(e.request)}))});
